...
import { TechClubTabs } from "../techclub/TechClubTabs";
import { TechClubContent } from "../techclub/TechClubContent";
        ...
        <div className="relative p-12">
          <div className="max-w-3xl">
            ...
            <p className="text-matrix/80 text-xl mt-6 font-code">
              Where code meets mystery. Join our exclusive community of digital
              detectives and puzzle solvers.
            </p>
