...
const InventoryItem = ({ name, rarity, image }: InventoryItemProps) => (
...
const categories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        rarity: "Epic",
        image:
          "https://images.unsplash.com/photo-1534294668821-28a3054f4256?w=200&h=200&fit=crop",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        rarity: "Epic",
        image:
          "https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=200&h=200&fit=crop",
      },
      {
        id: 4,
        name: "Pioneer",
        rarity: "Rare",
        image:
          "https://images.unsplash.com/photo-1614107707379-283a65774553?w=200&h=200&fit=crop",
      },
    ],
  },
  {
