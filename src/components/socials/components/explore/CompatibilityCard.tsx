...
export const CompatibilityCard = ({ profile, matchPercentage }: CompatibilityCardProps) => {
  return (
    <div className="bg-zinc-900 rounded-lg p-6 border border-zinc-800 shadow-lg hover:shadow-xl transition-shadow">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-zinc-300">{profile.coreValues.attachmentStyle} attachment</span>
        </div>
