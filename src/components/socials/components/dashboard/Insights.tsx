...
import { TrendingUp, Users, BarChart2, Eye, Heart, MessageCircle, Share2 } from 'lucide-react';
    ...
    <div className="bg-zinc-900 rounded-lg p-6 border border-zinc-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          {Object.entries(followerInsights.demographics.age).map(([age, percentage]) => (
        ...
        <div>
          ...
          {Object.entries(followerInsights.demographics.location).map(([location, percentage]) => (
        ...
        <div>
          ...
          {Object.entries(followerInsights.demographics.interests).map(([interest, percentage]) => (
    ...
    <div className="bg-zinc-900 rounded-lg p-6 border border-zinc-800">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-zinc-800/50 rounded-lg p-4">
          ...
          <div className="text-zinc-200">{contentInsights.performance.views.toLocaleString()}</div>
        </div>
        ...
        <div className="bg-zinc-800/50 rounded-lg p-4">
          ...
          <div className="text-zinc-200">{contentInsights.performance.likes.toLocaleString()}</div>
        </div>
        ...
        <div className="bg-zinc-800/50 rounded-lg p-4">
          ...
          <div className="text-zinc-200">{contentInsights.performance.comments.toLocaleString()}</div>
        </div>
        ...
        <div className="bg-zinc-800/50 rounded-lg p-4">
          ...
          <div className="text-zinc-200">{contentInsights.performance.shares.toLocaleString()}</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {contentInsights.topPerforming.map((post) => (
          <div key={post.id} className="bg-zinc-800/50 rounded-lg overflow-hidden">
            <img src={post.thumbnail} alt="" className="w-full h-48 object-cover" />
            <div className="p-4">
