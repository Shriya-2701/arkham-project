...
export const StoreFilters = ({ filters, onFilterChange }: StoreFiltersProps) => (
  <div className="bg-[#1a0f0f]/90 p-6 rounded-lg border border-[#8B0000]/30 mb-8 academia-border">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <select
        ...
        onChange={(e) => onFilterChange({ ...filters, condition: e.target.value || null })}
        className="bg-[#0a0505] text-silver rounded-lg px-4 py-2 border border-[#8B0000]/30 academia-text"
      >
      ...
      <select
        ...
        onChange={(e) => onFilterChange({ ...filters, sortBy: e.target.value as StoreFiltersType['sortBy'] })}
        className="bg-[#0a0505] text-silver rounded-lg px-4 py-2 border border-[#8B0000]/30 academia-text"
      >
