...
import { MediaClubHeader } from '../components/mediaclub/MediaClubHeader';
import { MediaClubTabs } from '../components/mediaclub/MediaClubTabs';
import { MediaClubContent } from '../components/mediaclub/MediaClubContent';
...
const MediaClub = () => {
  ...
  return (
    <div className={`max-w-7xl mx-auto min-h-screen p-8 rounded-lg ${mode}-mode`}>
      {/* Mode Toggle */}
      ...
      <div className="relative">
        {mode === 'detective' && <div className="absolute inset-0 scan-effect" />}
        <div className="relative z-10">
          <MediaClubHeader mode={mode} />
          <MediaClubTabs activeTab={activeTab} onTabChange={setActiveTab} mode={mode} />
